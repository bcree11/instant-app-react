...
declare global {
  namespace JSX {
    interface IntrinsicElements {
      ...
      "calcite-action": JSX.CalciteAction &
      ...
      "calcite-color": Omit<JSX.CalciteColor, "onCalciteColorChange"> &
        JSXInternal.HTMLAttributes<HTMLCalciteColorElement> & {
          oncalciteColorChange?: (event: CustomEvent<any>) => void;
        };

      "calcite-color-hex-input": Omit<
        JSX.CalciteColorHexInput,
        "onCalciteColorHexInputChange"
      > &
        JSXInternal.HTMLAttributes<HTMLCalciteColorHexInputElement> & {
          oncalciteColorHexInputChange?: (event: CustomEvent<any>) => void;
        };

      "calcite-color-swatch": JSX.CalciteColorSwatch &
        JSXInternal.HTMLAttributes<HTMLCalciteColorSwatchElement>;

      "calcite-combobox": Omit<
        JSX.CalciteCombobox,
        "onCalciteLookupChange" | "onCalciteComboboxChipDismiss"
      > &
      ...
      "calcite-date-month": Omit<
        JSX.CalciteDateMonth,
        "onCalciteDateSelect" | "onCalciteActiveDateChange"
      > &
      ...
      "calcite-date-month-header": Omit<
        JSX.CalciteDateMonthHeader,
      ...
      "calcite-tab": Omit<
        JSX.CalciteTab,
        "onCalciteTabRegister" | "onCalciteTabUnregister"
      > &
